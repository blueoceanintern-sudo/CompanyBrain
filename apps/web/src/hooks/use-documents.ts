  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return result.data as Array<{
        id: string; orgId: string; compartmentId: string; filename: string
        accessTier: string; sourceType: string; status: string
        uploadedBy: string; version: number; previousVersionId: string | null
